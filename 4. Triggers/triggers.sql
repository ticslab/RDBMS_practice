...
Напишите триггер автоматически обновляемый время (на текущее), при внесении изменений в запись этой таблицы.
*/



/*
Задание 3. В таблице film есть поле rental_duration, которое отвечает за то, на какай срок можно взять фильм в аренду.
...
Используйте для этого таблицу rental, который проверяет, не просрочена ли аренда.
*/
